...
export const CONTENT_ITEMS: ContentItem[] = [
  // ── Workplace basics ──
  {
    ...
    comprehension: [
      ...
      { question: 'Why is taking notes during training a good idea?', options: ['To show off to colleagues', 'You will not remember everything and it shows you are taking it seriously', 'Your employer requires it by law', 'To pass the time'], correct: 1, explanation: 'Taking notes means you have a reference to look back on, and it visibly demonstrates to your employer that you are engaged.' },
  ...
  },
  {
    ...
    comprehension: [
      ...
      { question: 'You finish a task at work. What should you do next?', options: ['Take a break', 'Check your phone', 'Look for what needs doing next or ask your manager', 'Wait to be told'], correct: 2, explanation: 'Taking initiative — finding the next task without being asked — is one of the qualities employers value most.' },
      { question: 'You make a mistake at work. What does this guide say you should do?', options: ['Fix it quietly and hope nobody notices', 'Blame a colleague', 'Own it and tell your manager', 'Ignore it'], correct: 2, explanation: 'Honesty builds trust. Telling your manager about a mistake — even a small one — shows maturity and stops the problem from getting worse.' },
    ],
  },
  {
    key: 'how_to_call_in',
    ...
    comprehension: [
      ...
      { question: 'When should you tell your manager you cannot come in?', options: ['After your shift would have started', 'As early as possible — before the shift', 'Whenever you feel like it', 'Only if they ask'], correct: 1, explanation: 'Telling them as early as possible — ideally the night before or hours before — gives them time to find cover.' },
  ...
  // ── Interview preparation ──
  {
    ...
    comprehension: [
      ...
      { question: 'What is the safest interview outfit choice if you are unsure?', options: ['Your most casual clothes to seem relaxed', 'Smart casual — clean trousers/skirt, neat shirt, closed-toe shoes', 'A full suit regardless of the company', 'Whatever you wear to school'], correct: 1, explanation: 'Smart casual is the universally safe interview choice — it shows effort and professionalism without being overdressed for the company culture.' },
      { question: 'Why should you avoid strong perfume or aftershave at an interview?', options: ['It is too expensive', 'The interviewer should remember your answers, not your scent', 'It is unprofessional to wear any', 'Only managers can wear it'], correct: 1, explanation: 'Strong scents can be distracting or even off-putting. You want the interviewer focused entirely on what you say.' },
    ],
  },
  {
    ...
    comprehension: [
      ...
      { question: 'Which topic should you avoid bringing up in a first interview?', options: ['Training opportunities', 'Salary and holiday', 'Day-to-day responsibilities', 'The team you would work with'], correct: 1, explanation: 'Asking about salary or holiday in a first interview comes across as prioritising personal gain over the job itself. Wait until the employer raises it.' },
      { question: 'Why is asking "When might I hear back?" a good interview question?', options: ['It puts pressure on the employer', 'It is professional, shows organisation, and demonstrates you are keen', 'It forces them to make a decision immediately', 'It is just small talk'], correct: 1, explanation: 'Asking about next steps is a confident, professional close to an interview. It shows you are organised and genuinely interested in the outcome.' },
    ],
  },
  {
    ...
    comprehension: [
      { question: 'Why should you practise interview answers out loud rather than just in your head?', options: ['It is not important — just read them', 'Saying them aloud makes them more natural and builds real confidence', 'It impresses interviewers if you mention it', 'So you can memorise a script word for word'], correct: 1, explanation: 'Practising out loud is fundamentally different from reading silently. It builds the muscle memory and fluency you need under pressure.' },
      { question: 'Why is planning your journey to the interview important?', options: ['To show the employer your route', 'Being late — even with a good reason — creates a bad first impression', 'So you can take the scenic route', 'It is not important'], correct: 1, explanation: 'Arriving late, regardless of the reason, sets a negative tone. Planning ahead removes that risk entirely.' },
      { question: 'What is a good way to answer questions about skills you might not have direct experience in?', options: ['Say you have the skill even if you do not', 'Use examples from school, sport, or volunteering to show you have the underlying quality', 'Avoid those questions', 'Change the subject'], correct: 1, explanation: 'Employers understand young people have limited work history. Drawing on school, sports, or volunteering is entirely valid — it shows self-awareness and transferable skills.' },
    ],
  },
  // ── Research skills ──
  {
    ...
    comprehension: [
      { question: "What should you look at on a company's social media before applying?", options: ['Their follower count', 'The tone and culture — how they present themselves', "Their competitors' accounts", 'Whether they post daily'], correct: 1, explanation: "Social media reveals the company's personality and culture — formal or relaxed, community-driven or commercial — which helps you tailor your application and prepare for interview." },
      { question: "Why is it useful to know who a company's competitors are?", options: ['So you can apply to them instead', 'It shows commercial awareness, which impresses interviewers', 'So you can criticise the business', 'It is not useful'], correct: 1, explanation: 'Knowing the competitive landscape shows maturity and business awareness — it demonstrates you understand the industry, not just the job.' },
      { question: 'How should you use your research during the interview?', options: ['Keep it to yourself', 'Reference specific things you found — "I noticed you recently launched X"', 'Recite their entire website from memory', 'Only mention it if asked directly'], correct: 1, explanation: 'Referencing specific details — a recent award, a new product, a community project — shows you genuinely researched the company and are not just saying what every other candidate says.' },
    ],
  },
  // ── Skills for work ──
  {
    ...
    comprehension: [
      { question: 'You do not understand an instruction your manager has given you. What should you do?', options: ['Guess and hope for the best', 'Ask for clarification — it is professional, not a sign of weakness', 'Ask a colleague to explain it instead', 'Ignore it'], correct: 1, explanation: 'Asking for clarification is always the right call. It prevents mistakes and shows you care about doing the job correctly.' },
      { question: 'What does good body language look like in a professional setting?', options: ['Arms crossed, looking down', 'Sitting up straight, open posture, nodding to show engagement', 'Looking at your phone between instructions', 'Leaning back in your chair'], correct: 1, explanation: 'Open, upright posture signals confidence and engagement. Your body communicates as much as your words — employers and interviewers notice both.' },
      { question: 'Why is it important to slow down when speaking, especially when nervous?', options: ['So you use fewer words', 'Rushing makes you harder to understand and less confident-sounding; pausing shows you are thinking', 'It makes the conversation longer', 'Employers prefer slow speakers'], correct: 1, explanation: 'Nerves cause rushing, which makes speech unclear. Taking a breath and slowing down actually sounds more confident and considered.' },
    ],
  },
  {
    key: 'open_mindedness',
    ...
    comprehension: [
      { question: 'Your manager gives you critical feedback on your work. What is the best response?', options: ['Defend yourself and explain why you did it that way', 'Say "thank you, I will work on that" and act on it', 'Complain to a colleague about it later', 'Ignore it'], correct: 1, explanation: 'Taking feedback well — without defensiveness — is one of the most valued qualities in any workplace. Managers specifically remember those who respond positively.' },
      { question: 'You are asked to do a task you have never done before. What should you do?', options: ['Refuse until you receive training', 'Give it a go — employers value people who try', 'Say you are not qualified', 'Wait until someone shows you first every time'], correct: 1, explanation: 'Willingness to try new things shows initiative and adaptability. Perfection is not expected from the start — effort and attitude are.' },
      { question: 'What does having a "growth mindset" mean at work?', options: ['Believing you are already perfect', 'Believing you can improve through effort and learning from mistakes', 'Always asking for a pay rise', 'Avoiding difficult tasks'], correct: 1, explanation: 'A growth mindset means seeing mistakes as learning opportunities rather than failures. Employers value people who continually improve.' },
    ],
  },
  {
    ...
    comprehension: [
      { question: 'A customer is being rude and difficult. What is the right response?', options: ['Be rude back to match their energy', 'Stay calm, stay professional, and escalate to a manager if needed', 'Walk away without saying anything', 'Argue your point until they back down'], correct: 1, explanation: 'Staying calm under pressure is one of the most valued professional skills. Escalating to a manager when needed shows good judgement, not weakness.' },
      { question: 'Why does it matter how you approach small, unglamorous tasks?', options: ['It does not matter — only big tasks count', 'Employers judge your attitude on small tasks to decide if you are ready for bigger responsibilities', 'Small tasks are just to fill time', 'Only managers do small tasks'], correct: 1, explanation: 'The attitude you bring to every task — however small — is exactly how employers evaluate you. Cutting corners on small jobs signals you will do the same on important ones.' },
      { question: 'What does it mean to be a "team player" at work?', options: ['Always doing things your own way', "Helping colleagues, sharing the load, and supporting the whole team — not just yourself", 'Making sure you always get the credit', 'Competing with your colleagues'], correct: 1, explanation: "Being a team player means lifting everyone around you. Employers value this enormously — the team's success is more important than any individual's." },
    ],
  },
];
